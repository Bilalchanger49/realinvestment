                            ...
                            <div class="widget widget-category">
                                <form action="" method="POST">
                                    ...
                                    <div class="mt-2 d-flex justify-content-between align-items-center" style="border-bottom: 1px solid black;">
                                        ...
                                        <p id="sharePrice" class="mb-0 text-right">255</p>
                                    </div>

                                    <!-- Input to select the number of shares -->
                                    <div class="mt-3">
                                        <label for="numShares">Number of Shares to Buy:</label>
                                        <input type="number" id="numShares" name="numShares" class="form-control" min="1" max="200" value="1" onchange="calculateTotal()">
                                    </div>

                                    <!-- Display the total price -->
                                    <div class="mt-3 d-flex justify-content-between align-items-center" style="border-bottom: 1px solid black;">
                                        <label>Total Price</label>
                                        <p id="totalPrice" class="mb-0 text-right">255</p>
                                    </div>

                                    <!-- Buy button -->
                                    <div class="mt-3 text-center">
                                        <div class="btn-wrap">
                                            <a class="btn btn-base w-md-auto w-50" href="#">Buy</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
