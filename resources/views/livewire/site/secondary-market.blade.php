    ...
    <div class="blog-page-area pd-top-90">
        <div class="container">
                        ...
                        <div class="row custom-gutters-20">
                            ...
                            <div class="col-md-3 mt-2 mt-md-0 align-self-center">
                                <div class="single-select-inner">
                                    <select>
                                        <option value="1">Sort By Price</option> <!-- Changed to sort by price for real estate -->
                                        <option value="2">Sort By Location</option> <!-- Changed to sort by location -->
                                        <option value="3">Sort By Return Potential</option> <!-- Changed to sort by investment potential -->
                                    </select>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card__article position-relative">
                        <img src="assets/img/banner/2.png" alt="Bojcin Forest, Serbia" class="card__img rounded-3 w-100">
                        <div class="card__data position-absolute bg-white shadow rounded-3">
