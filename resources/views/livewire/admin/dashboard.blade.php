...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const propertyTypeChartData = @json($propertyTypeChartData);
        const biddingLineChartData = @json($biddingLineChartData);
        ...
        //         datasets: [
        //             {label: "Bids", backgroundColor: "#6366f1", data: monthlyChartData.bids},
        //             {label: "Sold", backgroundColor: "#10b981", data: monthlyChartData.sold},
        //             {label: "Profit", type: 'line', borderColor: "#f59e0b", data: monthlyChartData.profit, fill: false}
        //         ]
        //     },
        //     options: {
        //         responsive: true,
                ...
                datasets: [
                    {
                        ...
                        data: [45, 60, 55, 70, 90, 110, 80, 75, 95, 65, 50, 60]
                    },
                    {label: "Sold", backgroundColor: "#10b981", data: [30, 45, 50, 60, 80, 95, 60, 70, 85, 55, 40, 50]},
                    {
                        ...
                        type: 'line',
                        borderColor: "#f59e0b",
                        data: [15, 25, 20, 30, 10, 40, 20, 30, 40, 25, 20, 30],
                        fill: false
                    }
                ]
            },
