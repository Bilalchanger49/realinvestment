                ...
                <div class="nav-right-part nav-right-part-desktop collapse navbar-collapse" id="dkt_main_menu">
                    <ul class="navbar-nav menu-open text-center">
                        ...
                        <li class="menu-item-has-children current-menu-item d-none d-lg-block" style=" width: 125px;">
                            ...
                            {{-- <img src="assets/img/agent/3.png" class="user-image rounded-circle"
                                style="height: 40px;" --}} {{-- alt="" />--}}
                            @if(Auth::User()->profile_photo_path)
                            <img src="{{asset('storage/'. Auth::User()->profile_photo_path)}}"
                                class="user-image rounded-circle" style="height: 40px;" alt="" />
                            @else
                        ...
                        <li class="menu-item d-lg-none text-center">
                            ...
                            <a href="{{ route('logout') }}" class="btn btn-register" onclick="event.preventDefault();
                                        document.getElementById('logout-form').submit(); ">
                                {{ __('Logout') }}
                            </a>
                            <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
                        ...
                        <div class="notification-dropdown">
                            ...
                            <footer class="border-top dropdown-notify-footer">
                                <div class="d-flex justify-content-between align-items-center py-2 px-3">
                                    <span>Last updated {{ \Carbon\Carbon::now()->diffForHumans() }}</span>
                                    <a id="refresh-button" href="javascript:void(0);"
                                        class="btn btn-sm btn-light mdi mdi-cached"></a>
                                </div>
                            </footer>
                        </div>
                    </div>
