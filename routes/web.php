...
Route::middleware([
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::get('/blog-categories', CategoryComponent::class)->name('admin.category');
        Route::get('/blog-categories/create', CreateCategoryComponent::class)->name('admin.category.create');
